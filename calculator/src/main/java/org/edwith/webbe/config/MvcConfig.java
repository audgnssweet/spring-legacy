package org.edwith.webbe.config;
...
@EnableWebMvc
@EnableSwagger2
@ComponentScan(basePackages = {"org.edwith.webbe.controller"})
public class MvcConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .paths(PathSelectors.ant(
                "/api/**"))// PathSelectors.any() 를 할경우 모든 경로가 다 사용된다. RestController가 아닌 것 까지 사용된다.
            .build()
            .apiInfo(apiInfo())
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfo("Swagger Sample", "APIs Sample", "Sample Doc 0.1v", "", contact,
